...
--
-- Host: localhost    Database: soidao_local
-- ------------------------------------------------------
...
LOCK TABLES `ita` WRITE;
/*!40000 ALTER TABLE `ita` DISABLE KEYS */;
/*!40000 ALTER TABLE `ita` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `news` VALUES (1,'เทส',NULL,'[\"https://i.postimg.cc/Kv2R1YXY/536282702-2324807874602853-8825489488780617642-n.jpg\"]','','2025-10-30 03:27:50');
...
-- Dump completed on 2025-10-30 10:32:05
